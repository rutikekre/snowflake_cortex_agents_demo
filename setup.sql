...
-- Create a Streamlit app based on the status of Behavior Change Bundle 2025_02
BEGIN
  -- Check if 2025 Bundle is enabled (for multi-page Streamlit apps)
  LET status_2025_02 STRING := (SELECT SYSTEM$BEHAVIOR_CHANGE_BUNDLE_STATUS('2025_02'));
  
  -- Log the bundle status
  SYSTEM$LOG_INFO('Bundle 2025_02 is ' || :status_2025_02);
  
  -- Check if the bundle is ENABLED or RELEASED and execute appropriate commands
  IF (status_2025_02 = 'ENABLED' OR status_2025_02 = 'RELEASED') THEN
    -- If bundle 2025_02 is DISABLED, the compiler won't recognize the new CREATE STREAMLIT syntax
    ...
    RETURN 'Bundle 2025_02 is ENABLED. Created Streamlit app with multi-file editing.';
  ...
  ELSE
    ...
    RETURN 'Bundle 2025_02 is DISABLED. Created Streamlit app with single file editing.';
  END IF;
END
